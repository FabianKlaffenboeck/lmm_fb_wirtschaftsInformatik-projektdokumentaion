...
Seit der Erfindung von Bosch, ist der CAN Bus vorallem im automotive Bereich zu finden, wird aber auch vermehrt in andrehen Industrie bereichen eingesetzt.
...
[
  ...
  ermöglicht, CAN Daten zu erfassen und zu analysieren, ohne vorher eine Langwierige und Kostenintensive Schulungen durchlaufen zu haben.
],[
  Echtzeit-Überwachung und Analyse: Das Tool muss in der Lage sein einen CanBus über 10 Minuten aufzuzeichnen und Grafisch darzustellen.  
],[
  ...
  CanBus Architektur: Es muss möglich sein den Bus in logische Einheiten (Channels und Nodes) zu unterteilen, und mit Hilfe einer so genannten DBC Datei aufzuschlüsseln.
],[
...
Als Komponenten Library kommt ShadCn aufgrund seines modernen Aussehens und der Verfügbarkeit des Source-Codes, was Anpassungen vereinfacht.
...
von Kvaser bereit gestellte, API der CanBus zu USB-Wandler zuzugreifen. 
