...
Da es sich bei diesem Prototyp um die Prototypenentwicklung für ein späteres Produkt handelt, wird ein besonderes Augenmerk auf die Session leerend gelegt, um es der späteren Entwicklung so leicht wie möglich zu machen, ein fertiges Hardware-Software-Produkt auf den Markt zu bringen. Somit dient das Resultat der Projektarbeit als Grundlage für eine folgende Entwicklung eines vollwertigen Produktes.
