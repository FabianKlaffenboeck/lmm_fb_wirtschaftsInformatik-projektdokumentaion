...
Jedes #acr("CAN")-Bus interface kann einem Netztwerk zugewiesen werden. Dabei ist zu beachten,
sollte eine interface Hardware mehrere Anschlüsse haben, so wird jedes Bus Interface als eigener #acr("CAN")-Cannel aufgelistet.


#pagebreak()
== Node werwaltung
#image("../images/Screenshots/{F90B9BC5-281D-42B9-868A-11CEF96E836D}.png", height: 20em)
#acr("CAN") Nodes werden auf der linken hälfte der einstellungen verwalted. Dabei ist zu beachten das grundsätzlich unbegrenzt viele Nodes
angelegt werden können, allerdings ist auf die Bus-auslastung zu achten. Jeder Node zeichnet sich durch ein Netzwerk und eine zugewiesene DBC Datei aus.
Der Node Name sollte kurz und pregnant sein, um die Auflistung übersichtlich zu halten.
...
#acr("DBC") Dateien können mittels einen Klick auf "Add DBC" ausgewählt und hochgeladen werden.
